...
import type { DayOfWeekCouponFieldsProps } from "./types";

export const DayOfWeekCouponFields = ({
  dayOfWeekOptions,
  discountTypeOptions,
  discountValueLabel,
  discountValueHelper,
}: DayOfWeekCouponFieldsProps) => {
  ...
  return (
    <View className="gap-4">
      <FormSelect
        name="dayOfWeek"
        label={t("Coupon.dayOfWeek")}
        placeholder={t("Coupon.selectDayOfWeek")}
